                                    ...
                                    <Stack gap={2}>
                                        <Stack gap={1} mt={1}>
                                            <Stack direction={'row'} gap={1}>
                                                ...
                                                <Typography>116 مقاله انگلیسی</Typography>
                                            </Stack>
                                            <Stack direction={'row'} gap={1}>
                                                <QuizOutlinedIcon color="secondary" />
                                                <Typography>
                                                    هر مقاله شامل تست های 4 گزینه ای می باشد
                                                </Typography>
                                            </Stack>
                                            <Stack direction={'row'} gap={1}>
                                                <NewspaperOutlinedIcon color="secondary" />
                                                <Typography>
                                                    20 paricoin برای مطالعه و انجام تست هر مقاله
                                                </Typography>
                                            </Stack>
                                        </Stack>
                                        <Typography>
                                            Parihan English این مقالات را برای تقویت بیشتر زبان شما
                                            طراحی نموده است، لطفا به عنوان بخشی از تمرینات روزانه
                                            خود این مقالات را مطالعه و تمرینات آنها را انجام دهید.
                                        </Typography>
                                    </Stack>
                                </AccordionDetails>
                            </Accordion>
                                ...
                                <AccordionDetails>
                                    ...
                                    >
                                        <ListItem disablePadding>
                                            <ListItemButton
                                                onClick={() =>
                                                    router.push('/dashboard/courses/article/1')
                                                }
                                            >
                                                <ListItemIcon>
                                                    <CheckIcon color="primary" />
                                                </ListItemIcon>
                                                <ListItemText primary="1. Exploring Culinary Passion" />
                                            </ListItemButton>
                                        </ListItem>
                                        <ListItem disablePadding>
                                            <ListItemButton>
                                                ...
                                                <ListItemText primary="2. The Power of Language" />
                                            </ListItemButton>
                                        </ListItem>
                                    </List>
                                </AccordionDetails>
